...
public final class QueryUtils {
    ...
    */
    ...
    private static ArrayList<Earthquake> extractEarthquakeFeatureFromJson(String earthquakeJSON) {
        ...
        try {
           /* JSONObject baseJsonResponse = new JSONObject(earthquakeJSON);
            ...
            for(int i = 0 ; i < features.length() ; i++)
            {
                ...
                earthquakes.add(new Earthquake(mag, place, URL, time));
            }
    ...
    public static ArrayList<Earthquake> fetchEarthquakeData(String requestUrl) {
        ...
        ArrayList<Earthquake> earthquakes = extractEarthquakeFeatureFromJson(jsonResponse);
